...
export default function MyReferencesList() {
    ...
    useEffect(() => {
        async function fetchData() {
            try {
                const response = await fetch(BASE_URL + "/backend/files/reference/" + session.userID, {
                    headers: {
                        'Authorization': `Token ${session.accessToken}`
                    },
                }
                ...
                <main>
                    ...
                    <div className="bg-slate-100 px-5 text-sm">
                        <div className="bg-white rounded-md px-7 py-5 space-y-3">
                            <p className="font-bold text-md mb-3">My reference files</p>
                            {files.length > 0 ? (
                                files.map((file) => {
                                        return (
                                            <div
                                            ...
                                            >
                                                ...
                                                <div className="flex flex-row space-x-3 items-center mr-2">
                                                    ...
                                                    <Link
                                                        href={{
                                                            pathname: "/files/references/edit/" + file.slug,
                                                            query: {
                                                                id: file.id,
                                                            },
                                                        }}
                                ...
                                <p className="text-center p-5">No reference files uploaded.</p>
                            )}
                        </div>
                    </div>
                </main>
